...
function TeacherProfile(){
    ...
    const teacherData = userData.teacherDoc;
...
return (
    <form  style={{height:'100vh',width:'100vw', background: '#182835',position:'absolute',top:'0',left:'0'}}>
        ...
        <Typography style={{ textTransform: 'capitalize', marginLeft:'1vw',marginTop:'10px',fontSize:'20px',fontWeight:'400'}} display='inline'>{`${teacherData.firstName} ${teacherData.middleName} ${teacherData.lastName}`}</Typography>
        <br/>
        ...
        <Typography style={{marginLeft:'1vw',marginTop:'10px',fontSize:'20px',fontWeight:'400'}} display='inline'>{teacherData.branch.toUpperCase()}</Typography>
        <br/>
        <br/>
