...
const CreateStudent = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const studentData = {
            firstName,middleName,lastName,branch,Class,sem
        }
        const teacherData = {}
        const reqBody = {
        ...
        <div>
            <form onSubmit={handleSubmit}>
                <Grid container style={ {flexGrow: 1, marginTop: 25, padding: 10} } spacing={2}>
                    ...
                    <Grid item xs={6}>
                        <TextField value={email} onChange={(e)=>{setEmail(e.target.value.toLowerCase())}} fullWidth required label="Email" variant="outlined"/>
                    </Grid>
                    <Grid item xs={6}>
                    ...
                    <Grid container item justify="center" alignItems="center">
                        <Box mt={5}>
                        {isLoading ?<CircularProgress />:<Button type="submit" variant="contained" color="primary">Create Student</Button>}
                        </Box>
                    </Grid>
                    ...
                    <Grid container item justify="center" alignItems="center">
                            {isSuccess ?<Alert variant="filled" severity="success">Student Created!</Alert>:<></>}
                    </Grid>
                </Grid>
            </form>
        </div>
